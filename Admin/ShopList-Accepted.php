...
<title>MY SHOP | APPROVED SHOPS</title>
</head>

<body style="background-color:#FCFCF8">
<h2 align="center" style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif">Approved Shops</h2>
<form id="form1" name="form1" method="post" action="">
  <table width="75%" border="5" align="center" style="background-color:#FFF" style="font-family:'Palatino Linotype', 'Book Antiqua', Palatino, serif">
    ...
    <?php
		...
		$selQuery = "select * from tbl_shops shop inner join tbl_places place on shop.place_id = place.place_id where shopStatus ='1'";
