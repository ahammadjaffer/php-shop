<?php
	...
	//To get cart id from url
	$cartId = $_GET['cartid'];
	$_SESSION['crtId']=$cartId;
	
	//To get item total of single row from table cart
	$selQuery = "select * from tbl_cart c inner join tbl_items i on c.itemId = i.itemId inner join tbl_shops s on i.shopId = s.shopId where cartId = '".$cartId."'";
	$res = mysql_query($selQuery);
	$row = mysql_fetch_array($res);
	
	//To select user details from table userreg
	$selUserQuery = "select * from   tbl_shopsuserreg s inner join tbl_places p on s.place_id=p.place_id inner join tbl_district d on p.district_id=d.district_id where userId= '".$_SESSION['loggedInId']."'";
	$Userres = mysql_query($selUserQuery);
	$Userrow=mysql_fetch_array($Userres);
	
	 if(isset($_POST['btnsub']))
      {
	    header('location:Third.php?&cartid='.$cartId);
                ...
                <table class="auto-style1">
                    <tr>
                        ...
                        <td class="auto-style28">
                             <input type="text "runat="server" ForeColor="#33CC33" style="font-weight: 700"value="<?php echo $row['shopName']; $_SESSION['shopName']= $row['shopName'];?>"/>
                    ...
                    <tr>
                        ...
                        <td class="auto-style26">
                            <span class="auto-style62">Rs.</span><input ytpe="text" runat="server" ForeColor="#33CC33" style="font-weight: 700" CssClass="auto-style62"value="<?php echo $row['itemTotal']; $_SESSION['totalPrice']=$row['itemTotal']; ?>"/>
            ...
            <td class="auto-style36"><fieldset><legend>Card Details</legend>
                <table class="auto-style1">
                    ...
                    <tr>
                        ...
                        <td class="auto-style26">
                            <input type="text" runat="server" style="font-weight: 700" value="1234567887654321"/>
                        </td>
                    </tr>
                </table>
                </fieldset></td>
                            ...
                            <table class="auto-style1">
                                <tr>
                                    ...
                                    <td class="auto-style52" colspan="2">
                                        <input type="text" name="txtName" runat="server" Width="300px" value="<?php echo $Userrow['userName'];?>"/>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style52" colspan="2">
                                        <input type="text" name="txtState" runat="server" Width="300px" value="<?php echo $Userrow['place_name'];?>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="auto-style55">3. *Email</td>
                                    <td class="auto-style55" colspan="2">
                                        <input type="text" name="txtEmail" runat="server" Width="300px" value="<?php echo $Userrow['userEmail'];;?>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="auto-style56">4. *Phone</td>
                                    <td class="auto-style56">
                                        <input type="text" name=="txtPhone" runat="server" Width="300px"value="<?php echo $Userrow['userContact'];?>"/>
                                    </td>
                                    <td class="auto-style56">
