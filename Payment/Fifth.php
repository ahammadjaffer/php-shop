<?php
  ...
  {
	 $insqry="insert into tbl_payment(worker_id,payment_amount,auction_id,payment_status)values('".$_SESSION['workerid']."','".$_SESSION['auction_amount']."','".$_SESSION['auction_id']."','1')";
	 echo $insqry;
	 mysql_query($insqry);
  }
                    ...
                    <table class="auto-style1">
                        <tr>
                            ...
                            <td class="auto-style32">
                                &nbsp;<input type="text"  runat="server" value="<?php echo $_SESSION['worker_name'];?>"/>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="auto-style38">
                                Rs.<input type="text" runat="server" value="<?php echo $_SESSION['auction_amount'];?>"/>
                                <strong>/-</strong></td>
                        </tr>
                        <tr>
