...
<?php
	...
	//To select shop table
	$selectShopQuery = "select * from tbl_cart c inner join tbl_items i on c.itemId=i.itemId inner join tbl_shops s on i.shopId = s.shopId where c.userId = '".$_SESSION['loggedInId']."' and c.cartStatus =0";
	$shopres = mysql_query($selectShopQuery);
	//echo $selectShopQuery;
	
	//To select User table
    ...
    <table class="auto-style1">
        <tr>
            ...
            <td class="auto-style58"><fieldset>
                <table class="auto-style1">
                <!-- To print each shop and their total price -->
                
                    <tr>
                        <td class="auto-style27">Pay To:</td>
                        <td class="auto-style28">
                             <input type="text "runat="server" ForeColor="#33CC33" style="font-weight: 700"value="mysite"/>
                    ...
                    <tr>
                        ...
                        <td class="auto-style26">
                            <span class="auto-style62">Rs.</span><input ytpe="text" runat="server" ForeColor="#33CC33" style="font-weight: 700" CssClass="auto-style62"value="<?php echo $total;?>"/>
                            ...
                            <table class="auto-style1">
                                <tr>
                                    ...
                                    <td class="auto-style52" colspan="2">
                                        <input type="text" name="txtName" runat="server" Width="300px" value="<?php echo $rowEdit['userName'];?>"/>
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style52" colspan="2">
                                        <input type="text" name="txtState" runat="server" Width="300px" value="<?php  echo $rowEdit['place_name'];?>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="auto-style55">3. *Email</td>
                                    <td class="auto-style55" colspan="2">
                                        <input type="text" name="txtEmail" runat="server" Width="300px" value="<?php   echo $rowEdit['userEmail'];?>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="auto-style56">4. *Phone</td>
                                    <td class="auto-style56">
                                        <input type="text" name=="txtPhone" runat="server" Width="300px"value="<?php  echo $rowEdit['userContact'];?>"/>
                                    </td>
                                    <td class="auto-style56">
