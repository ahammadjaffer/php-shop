<?php
	...
	{
		$ins = "insert into tbl_ShopAdminReg (adminName,adminUsername,adminPassword,place_id,adminEmail,adminContact,adminProof) value ('".$fname."','".$username."','".$password."','".$place."','".$email."','".$contact."','".$proof."')";
		mysql_query($ins);
...
<form id="form1" name="form1" enctype="multipart/form-data" method="post" action="" style="font-family:'Palatino Linotype', 'Book Antiqua', Palatino, serif">
  <table class="Register">
    ...
    <tr>
      <td>&nbsp;</td>
      <td><input type="submit" name="btnSubmit" id="btnSubmit" value="Register" class="button"/>
