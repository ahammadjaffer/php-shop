<?php
	...
	{
		$ins = "insert into tbl_shopsuserreg (userName,userEmail,userContact,userGender,userAddress,place_id,userUsername,userPassword,userSQans,userLoginStatus) value ('".$fname."','".$email."','".$contact."','".$gender."','".$address."','".$place."','".$username."','".$password."','".$sqans."',0)";
		mysql_query($ins);
...
<title>MY SHOP | USER REGISTRATION</title>
...
<form id="form1" name="form1" method="post" action=""  style="font-family:'Palatino Linotype', 'Book Antiqua', Palatino, serif">
  <table class="Register">
    ...
    <tr>
      <td>&nbsp;</td>
      <td><input type="submit" name="btn_register" id="btn_register" value="Register" class="button" />
      <input type="submit" name="btn_cancel" id="btn_cancel" value="Cancel" class="cancelbtn"/></td>
    </tr>
  </table>
</form>
</body>
